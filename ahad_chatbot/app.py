...
data = pickle.load( open( "C:/Users/harip/OneDrive/Desktop/ahad_chatbot/ahad-data.pkl", "rb" ) )
words = data['words']
...
with open(f'C:/Users/harip/OneDrive/Desktop/ahad_chatbot/ahad-model.pkl', 'rb') as f:
    model = pickle.load(f)
